...
from NIAF.continuous_sign_field.scripts.complete_guava_missing_frames import (
...
def test_gap_metadata():
    ...
    np.testing.assert_array_equal(missing_run_lengths(observed), [0, 2, 2, 0, 1, 0, 3, 3, 3])
    np.testing.assert_array_equal(nearest_observed_distance(observed), [0, 1, 1, 0, 1, 0, 1, 2, 3])
