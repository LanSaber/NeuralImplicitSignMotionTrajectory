...
- NIAF and flow launchers, NIAF-focused tests, and all NIAF/visualization docs.
...
- Exact frozen flow dependencies referenced by the migrated configurations:
  three adapter checkpoints and two VAE checkpoints, plus their lightweight
  experiment metadata.
...
- `ARTIFACT_MANIFEST.sha256` contains 5,887 per-file hashes for `deps/`,
