...
Date: 2026-07-16  
Status: improved C2/FK-temporal pilot completed; smoother than v1 with a measured positional tradeoff
...
No conversion to the general Flow training format described in `docs/flow/dataset/flow_training_dataset_format.md` was required. The fine-tuning code consumes the existing GUAVA completion NPZ files and aligned dense SOKE pose directories directly.
...
`experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/data_manifest.json`
...
Implementation: `NIAF/continuous_sign_field/guava_gap.py`
...
`experiments/NIAF/continuous_sign_field/smpl_samples_meta_implicit_soft_recon_stride8_fk_smooth/checkpoints/best.pt`
...
Implementation: `NIAF/continuous_sign_field/models/meta_implicit.py`
...
Calibrated bounds: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/bounds.json`
...
Training configuration: `NIAF/continuous_sign_field/configs/guava_mask_aware_meta_finetune.yaml`

Trainer: `NIAF/continuous_sign_field/scripts/train_guava_mask_aware_meta.py`

Best checkpoint: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/checkpoints/best.pt`
...
`visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/render_mask_finetuned`

Representative video:

`visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/render_mask_finetuned/FZCEymcpq7I_12-1-rgb_front_rgb_guava_slerp_mask_finetuned_jerk.mp4`

Metric overview:

`visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/pilot_metric_overview.png`
...
```bash
python -m NIAF.continuous_sign_field.scripts.train_guava_mask_aware_meta \
  --config NIAF/continuous_sign_field/configs/guava_mask_aware_meta_finetune.yaml \
  --prepare_only
```
...
python -m NIAF.continuous_sign_field.scripts.evaluate_guava_mask_aware_meta \
  --input \
  ...
  --checkpoint experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/checkpoints/best.pt \
  --out_dir visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot
```

### 15.4 Render Comparison Videos and Jerk Curves

```bash
python -m NIAF.continuous_sign_field.visualization.visualize_guava_bounded_meta_jerk \
  --input visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/fits/*_mask_finetuned.npz \
  --method mask_finetuned \
  --evaluation_summary visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/evaluation_summary.json \
  --out_dir visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/render_mask_finetuned \
...
- Gap conditioning and SO(3) projection: `NIAF/continuous_sign_field/guava_gap.py`
- Shared residual model: `NIAF/continuous_sign_field/models/meta_implicit.py`
- Fine-tuning trainer: `NIAF/continuous_sign_field/scripts/train_guava_mask_aware_meta.py`
- Evaluation: `NIAF/continuous_sign_field/scripts/evaluate_guava_mask_aware_meta.py`
- Visualization: `NIAF/continuous_sign_field/visualization/visualize_guava_bounded_meta_jerk.py`
- Configuration: `NIAF/continuous_sign_field/configs/guava_mask_aware_meta_finetune.yaml`

### Training Artifacts

- Parent checkpoint: `experiments/NIAF/continuous_sign_field/smpl_samples_meta_implicit_soft_recon_stride8_fk_smooth/checkpoints/best.pt`
- Fine-tuned checkpoint: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/checkpoints/best.pt`
- Resolved configuration: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/config.resolved.json`
- Data manifest: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/data_manifest.json`
- Bounds: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/bounds.json`
- Per-epoch metrics: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/metrics.jsonl`
- Training/validation curve: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_finetune/training_validation_curve.png`

### Evaluation Artifacts

- Aggregate evaluation: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/evaluation_summary.json`
- Per-sequence CSV: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/per_sequence_metrics.csv`
- Per-sequence JSONL: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/per_sequence_metrics.jsonl`
- Completed pilot fits: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/fits`
- Comparison videos: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/render_mask_finetuned`
...
- Temporal-loss implementation: `NIAF/continuous_sign_field/guava_temporal.py`
- Improved configuration: `NIAF/continuous_sign_field/configs/guava_mask_aware_meta_c2_fk_jerk_finetune.yaml`
- Improved checkpoint: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_finetune/checkpoints/best.pt`
- Per-epoch metrics: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_finetune/metrics.jsonl`
...
- Aggregate metrics: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/evaluation_summary.json`
- Per-sequence metrics: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/per_sequence_metrics.csv`
- Completed fits: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/fits`
...
- Render directory: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/render_c2_fk_meta`
- Render summary: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/render_c2_fk_meta/render_summary.json`
- Preview frames: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/render_c2_fk_meta/previews`
- Static jerk charts: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/render_c2_fk_meta/jerk_curves`
...
`experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_finetune_weight050`.
...
- Synthetic masking and local SO(3) scaffold: `NIAF/continuous_sign_field/guava_self_supervision.py`
- Trainer integration and validation diagnostic: `NIAF/continuous_sign_field/scripts/train_guava_mask_aware_meta.py`
- Configuration: `NIAF/continuous_sign_field/configs/guava_mask_aware_meta_c2_fk_jerk_guava_self_finetune.yaml`
- Tests: `tests/test_guava_masked_self_supervision.py`
- Selected checkpoint: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_finetune/checkpoints/best.pt`
- Per-epoch metrics: `experiments/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_finetune/metrics.jsonl`
- Pilot aggregate metrics: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/evaluation_summary.json`
- Pilot per-sequence metrics: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/per_sequence_metrics.csv`
- Pilot completed fits: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/fits`
...
- Render directory: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/render_c2_fk_guava_self_meta`
- Render summary: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/render_c2_fk_guava_self_meta/render_summary.json`
- Preview contact sheet: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/render_c2_fk_guava_self_meta/preview_contact_sheet.png`
- Static jerk charts: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/render_c2_fk_guava_self_meta/jerk_curves`
- Representative previews: `visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_guava_self_pilot/render_c2_fk_guava_self_meta/previews`
...
No conversion to `docs/flow/dataset/flow_training_dataset_format.md` is needed.
...
- SOKE-free trainer: `NIAF/continuous_sign_field/scripts/train_guava_self_only_meta.py`
- Multi-scale masking: `NIAF/continuous_sign_field/guava_self_supervision.py`
- Stable bounded SO(3) correction: `NIAF/continuous_sign_field/guava_gap.py`
- Configuration: `NIAF/continuous_sign_field/configs/guava_self_only_meta_c2_fk_jerk.yaml`
- Tests: `tests/test_guava_self_only_meta.py`
- Training manifest: `experiments/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_stable_so3_trunk5e5/data_manifest.json`
- Official fail-safe checkpoint: `experiments/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_stable_so3_trunk5e5/checkpoints/best.pt`
- Best safe diagnostic: `experiments/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_stable_so3_trunk5e5/checkpoints/best_safe_diagnostic.pt`
- Per-epoch metrics: `experiments/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_stable_so3_trunk5e5/metrics.jsonl`
- Report-only pilot summary: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/evaluation_summary.json`
- Pilot per-sequence metrics: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/per_sequence_metrics.csv`
- Pilot diagnostic fits: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/fits`
...
- Render directory: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/render_guava_only_diagnostic_four_panel`
- Render summary: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/render_guava_only_diagnostic_four_panel/render_summary.json`
- Preview contact sheet: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/render_guava_only_diagnostic_four_panel/preview_contact_sheet.png`
- Static jerk charts: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/render_guava_only_diagnostic_four_panel/jerk_curves`
- Representative previews: `visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/render_guava_only_diagnostic_four_panel/previews`
