...
from SOKE's software-mesh renderer
`NIAF/continuous_sign_field/visualization/visualize_guava_bounded_meta_jerk.py`,
...
Always run both scripts from the GUAVA repository root because the renderer
imports GUAVA-local modules:

```bash
cd /media/cvpr/haomian/GUAVA
```
...
export RENDER_SCRIPT=/media/cvpr/haomian/GUAVA/tools/render_guava_compact_motion.py
export COMPOSE_SCRIPT=/media/cvpr/haomian/GUAVA/tools/compose_guava_motion_comparison.py
...
```bash
export PILOT_ROOT="$SOKE_ROOT/visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot"
...
```bash
export PILOT_ROOT="$SOKE_ROOT/visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot"
export FITS="$PILOT_ROOT/fits"
export RENDER_ROOT="$PILOT_ROOT/guava_renders/women001"
export COMPARE_ROOT="$RENDER_ROOT/four_panel_comparisons"
...
```bash
export PILOT_ROOT="$SOKE_ROOT/visualize/NIAF/continuous_sign_field/guava_linear_siren_jerk_compare"
export FITS="$PILOT_ROOT/fits"
export RENDER_ROOT="$PILOT_ROOT/guava_renders/women001"
export COMPARE_ROOT="$RENDER_ROOT/four_panel_comparisons"
...
```bash
export PILOT_ROOT="$SOKE_ROOT/visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot"
export FITS="$PILOT_ROOT/fits"
export RENDER_ROOT="$PILOT_ROOT/guava_renders/women001"
export COMPARE_ROOT="$RENDER_ROOT/four_panel_comparisons"
...
```text
/media/cvpr/haomian/NeuralImplicitSignMotionTrajectory/visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_pilot/guava_renders/women001/four_panel_comparisons
```

Improved C2/FK-temporal:

```text
/media/cvpr/haomian/NeuralImplicitSignMotionTrajectory/visualize/NIAF/continuous_sign_field/guava_mask_aware_meta_c2_fk_jerk_pilot/guava_renders/women001/four_panel_comparisons
```

Linear versus direct SIREN:

```text
/media/cvpr/haomian/NeuralImplicitSignMotionTrajectory/visualize/NIAF/continuous_sign_field/guava_linear_siren_jerk_compare/guava_renders/women001/four_panel_comparisons
```

Retained-GUAVA-only rejected diagnostic:

```text
/media/cvpr/haomian/NeuralImplicitSignMotionTrajectory/visualize/NIAF/continuous_sign_field/guava_self_only_meta_c2_fk_jerk_soke_free_diagnostic_pilot/guava_renders/women001/four_panel_comparisons
```
