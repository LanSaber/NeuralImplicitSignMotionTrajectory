...
BATCH_SCRIPT="$PROJECT_DIR/scripts/NIAF/train_csl_daily_stage_c_generator_adaptation_pilot_sbatch.sh"
SMOKE_SCRIPT="$PROJECT_DIR/scripts/NIAF/smoke_csl_daily_stage_c_generator_adaptation_pilot_sbatch.sh"
CALIBRATION_SCRIPT="$PROJECT_DIR/scripts/NIAF/calibrate_csl_daily_stage_c_generator_adaptation_sbatch.sh"
CPU_SCRIPT="$PROJECT_DIR/scripts/NIAF/test_csl_daily_stage_c_generator_adaptation_sbatch.sh"
