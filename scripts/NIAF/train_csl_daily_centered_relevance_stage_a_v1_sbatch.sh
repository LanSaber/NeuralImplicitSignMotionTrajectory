#!/bin/bash
#SBATCH --job-name=csl_centered_a
...
export CENTERED_STAGE=stage1 CENTERED_RESUME="${CENTERED_RESUME:-0}"
export CENTERED_LAUNCHER="$PROJECT_DIR/scripts/NIAF/train_csl_daily_centered_relevance_stage_a_v1_sbatch.sh"
