#!/bin/bash
#SBATCH --job-name=csl_v3_splitkv_s2
...
export FACTORIZED_STAGE=stage2
export FACTORIZED_RESUME=0
export FACTORIZED_LAUNCHER="$PROJECT_DIR/scripts/NIAF/train_csl_daily_signtrajfield_v3_sentence_memory_phase_a_split_kv_temporal_bias_motion_contrast_v1_sbatch.sh"
